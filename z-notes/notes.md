...
- Go fue pensado para aprovechar losultimos avances en hardware, los multiprocesadores, enormes cantidades de memoria y el paralelismo.
- Go es un lenguaje compilado, generando archivos .exe portables a cualquier sistema operativo y version (Se exe contiene todo lo necesario para ejecutarse).
...
- Go es facil de entender, su sintaxis es clara y mejorada con respecto a otro lenguajes.
...
- Las funciones en Go pueden devovler mas de un valor.
- Se puede desarrollador en Go tanto instrucciones sincronicas como asincronicas.
- Solo existe la instrucción For para iteraciones (no existe While, ni Do Until, ni nada similar)
- Go no es un lenguaje orientado a objetos, y resuelve lo que conocemos como POO, con estructuras, Funciones, Metodos e interfaces)
